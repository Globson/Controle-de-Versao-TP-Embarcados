...
void setup()
{
    ...
    if(!Manual){
        ...
        if(Peso<=3){
      	...
      	if(Conf.DelayFechamento==0){Conf.DelayFechamento+=1;}
        if(Conf.Intervalo_Tempo==0){Conf.Intervalo_Tempo+=1;}
        lcd.clear();
        lcd.print("Intervalo: ");
...
void loop()
{
    ...
    lcd.clear();
    lcd.print("Intervalo: ");
    lcd.print((int)(Conf.Intervalo_Tempo/100));
    lcd.print(" Hrs");
    lcd.setCursor(0, 1);
    lcd.print("Despejo: ");
    lcd.print(Conf.DelayFechamento/1000);
    lcd.print(" Seg");
    delay(1000);
    if (analogRead(A5) != 0)
    {
